...
const api = {
  ...
  getTrendyolStatus: () => ipcRenderer.invoke('get-trendyol-status'),
  testTrendyolConnection: () => ipcRenderer.invoke('test-trendyol-connection'),
  triggerTrendyolPoll: () => ipcRenderer.invoke('trigger-trendyol-poll'),
  getTrendyolStoreStatus: () => ipcRenderer.invoke('get-trendyol-store-status'),
  updateTrendyolStoreStatus: (status: 'OPEN' | 'CLOSED') => ipcRenderer.invoke('update-trendyol-store-status', status),
