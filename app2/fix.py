...
file_path = r"C:\Users\bilal\SARACAPP\SARACAPPV3\app2\app\src\main\java\com\bilalgnd\saracapp\saracapp.kt"

with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

t1 = """                        val hapticFeedback = androidx.compose.ui.platform.LocalHapticFeedback.current
...
r1 = """                        val hapticFeedback = androidx.compose.ui.platform.LocalHapticFeedback.current
                        var accumulatedDrag by remember { mutableFloatStateOf(0f) }
